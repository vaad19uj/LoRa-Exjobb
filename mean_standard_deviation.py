...
for position in range(1,4):
    ...
    f_new = open("C:\\Users\\myran\Desktop\\Enchipsdatorer\\LoRa-Exjobb\\Testbed_2\\Testbed2_results\\MSD\\Position" + str(position) + "_MSD.txt", "w")
    combined_MSD = [0]*11
    for receiver in range(1,4):
        #Address in github repository
        f = open("C:\\Users\\myran\\Desktop\\Enchipsdatorer\\LoRa-Exjobb\\Testbed_2\\Testbed2_results\\Position" + str(position) + "\\Testbed2_data_rec" + str(receiver) + ".txt")
        txt = f.read()
